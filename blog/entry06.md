...
[Plan](../prep/presentation.md)  
[Presentation](https://docs.google.com/presentation/d/1GZ9ZRACa2AfFESe-rxQlKPPi3vjNhNrb_QnU8QKSSkI/edit?slide=id.p#slide=id.p)  
### EDP
I've just wrapped up the 8'th step of the _Engineering Design Process_, which is to **communicate your results**. We did this via a presentation and an expo in the cafeteria. If I had more time for this project, I would make some adjustments to the hitboxes (7'th step) as the hitboxes are slightly off.
### Skills
...
I also removed two different slides, both of them just about linking objects or variables to javascript.  
I ended up making the elevator pitch fit within the time limit.
